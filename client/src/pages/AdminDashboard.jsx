...
export default function AdminDashboard() {
  const [stats, setStats] = useState({}); const [users, setUsers] = useState([]);
  ...
  const load = async () => { const [s, u] = await Promise.all([api.get('/users/admin/stats'), api.get('/users/admin/users')]); setStats(s.data.stats || {}); setUsers(u.data.users || []); };
  useEffect(() => { load(); }, []);
