...
export default function MyAppointments() {
  ...
  const color = (status) => status === 'Approved' ? 'bg-green-100 text-green-700' : status === 'Completed' ? 'bg-blue-100 text-blue-700' : status === 'Cancelled' ? 'bg-red-100 text-red-700' : 'bg-yellow-100 text-yellow-700';
